...
public class QProducerJNDI {
    public QProducerJNDI(String messageStr) throws JMSException, NamingException {
    ...
    public static void main(String[] args) throws JMSException {
      if (args.length != 1) { 
        System.out.println("Expected arguments: <message(String)>");
        System.exit(1);
      }
